...
#define LPUART_UART_IP_SA_PBCFG_AR_RELEASE_MINOR_VERSION_C      9
#define LPUART_UART_IP_SA_PBCFG_AR_RELEASE_REVISION_VERSION_C   0
#define LPUART_UART_IP_SA_PBCFG_SW_MAJOR_VERSION_C              7
#define LPUART_UART_IP_SA_PBCFG_SW_MINOR_VERSION_C              0
#define LPUART_UART_IP_SA_PBCFG_SW_PATCH_VERSION_C              1
