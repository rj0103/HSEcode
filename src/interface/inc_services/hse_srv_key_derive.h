...
typedef struct
{
     ...
     *  @note HSE_M and HSE_B platforms do not support SHA2_384/512 hash algorithms for PBKDF2. */
...
typedef struct
{
     ...
     *                - For #pLabel = "client finished" or "server finished", pSeed must be Hash(handshake_messages).
