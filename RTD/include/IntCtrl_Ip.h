...
#define CDD_PLATFORM_INTCTRL_IP_SW_MAJOR_VERSION                   7
#define CDD_PLATFORM_INTCTRL_IP_SW_MINOR_VERSION                   0
#define CDD_PLATFORM_INTCTRL_IP_SW_PATCH_VERSION                   1
#define CDD_PLATFORM_INTCTRL_IP_AR_RELEASE_MAJOR_VERSION           4
#define CDD_PLATFORM_INTCTRL_IP_AR_RELEASE_MINOR_VERSION           9
