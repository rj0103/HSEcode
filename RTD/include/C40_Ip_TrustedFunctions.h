...
#define C40_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION_H        9
#define C40_IP_TRUSTEDFUNCTIONS_AR_RELEASE_REVISION_VERSION_H     0
#define C40_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION_H                7
#define C40_IP_TRUSTEDFUNCTIONS_SW_MINOR_VERSION_H                0
#define C40_IP_TRUSTEDFUNCTIONS_SW_PATCH_VERSION_H                1
...
/**
 * @brief        Read SETSLOCK_Reg_Value
 *
 * @param[in]    VirtualSector            Sector to be checked
 * @param[inout] SETSLOCKReg              Lock status value of the sector
 * @return       none
 *
 */
extern void C40_Ip_GetSETSLOCKRegValue(C40_Ip_VirtualSectorsType VirtualSector,  uint32 *SETSLOCKReg);

/**
 * @brief        Read LockDomainID value
 *
 * @param[in]    VirtualSector            Sector to be checked
 * @param[inout] LockDomainIDValue        The value of the domain ID
 *                                        of the master currently acquiring the lock bit.
 * @return       none
 *
 */
extern void C40_Ip_GetLockDomainIDValue(C40_Ip_VirtualSectorsType VirtualSector, uint8 *LockDomainIDValue);
