...
#define CACHE_IP_DEVASSERT_AR_RELEASE_MINOR_VERSION        9
#define CACHE_IP_DEVASSERT_AR_RELEASE_REVISION_VERSION     0
#define CACHE_IP_DEVASSERT_SW_MAJOR_VERSION                7
...
#if (CACHE_IP_DEVASSERT_VENDOR_ID != DEVASSERT_VENDOR_ID)
    #error "Cache_Ip_Devassert.h and Devassert.h have different vendor ids"
#endif

/* Check if header file and Devassert.h file are of the same Autosar version */
#if ((CACHE_IP_DEVASSERT_AR_RELEASE_MAJOR_VERSION != DEVASSERT_AR_RELEASE_MAJOR_VERSION) || \
     (CACHE_IP_DEVASSERT_AR_RELEASE_MINOR_VERSION != DEVASSERT_AR_RELEASE_MINOR_VERSION) || \
     (CACHE_IP_DEVASSERT_AR_RELEASE_REVISION_VERSION != DEVASSERT_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Cache_Ip_Devassert.h and Devassert.h are different"
#endif

/* Check if header file and Devassert.h file are of the same Software version */
#if ((CACHE_IP_DEVASSERT_SW_MAJOR_VERSION != DEVASSERT_SW_MAJOR_VERSION) || \
     (CACHE_IP_DEVASSERT_SW_MINOR_VERSION != DEVASSERT_SW_MINOR_VERSION) || \
     (CACHE_IP_DEVASSERT_SW_PATCH_VERSION != DEVASSERT_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Cache_Ip_Devassert.h and Devassert.h are different"
#endif
#endif /* STD_ON == CACHE_IP_DEV_ERROR_DETECT */
...
#include "Mcl_MemMap.h"
    ...
    #define CACHE_IP_DEV_ASSERT(x) DevAssert(x)
#else
