...
#define CACHE_IP_HWACC_ARMCOREMX_AR_RELEASE_MINOR_VERSION        9
#define CACHE_IP_HWACC_ARMCOREMX_AR_RELEASE_REVISION_VERSION     0
#define CACHE_IP_HWACC_ARMCOREMX_SW_MAJOR_VERSION                7
#define CACHE_IP_HWACC_ARMCOREMX_SW_MINOR_VERSION                0
#define CACHE_IP_HWACC_ARMCOREMX_SW_PATCH_VERSION                1
