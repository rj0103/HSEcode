...
#define LPUART_UART_IP_HWACCESS_AR_RELEASE_MINOR_VERSION     9
#define LPUART_UART_IP_HWACCESS_AR_RELEASE_REVISION_VERSION  0
#define LPUART_UART_IP_HWACCESS_SW_MAJOR_VERSION             7
#define LPUART_UART_IP_HWACCESS_SW_MINOR_VERSION             0
#define LPUART_UART_IP_HWACCESS_SW_PATCH_VERSION             1
...
{
    *(volatile uint8 *)(&(Base->DATA)) = (uint8)Data;
}
...
static inline void Lpuart_Uart_Ip_Putchar9(LPUART_Type * Base, uint16 Data)
{
    ...
    *(volatile uint8 *)(&(Base->DATA)) = (uint8)(Data & (uint16)UINT8_MAX);
}
