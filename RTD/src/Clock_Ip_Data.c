...
#endif
#if defined(CLOCK_IP_HAS_AES_ACCEL_CLK)
    {CLOCK_IP_PARTITION_1_INDEX,       CLOCK_IP_COLLECTION_3_INDEX,      MC_ME_PRTN1_COFB3_CLKEN_REQ112_SHIFT,        MC_ME_PRTN1_COFB3_CLKEN_REQ112_115_MASK},      /*   AES_ACCEL_CLK clock          */
#else
    {0U,                               0U,                               0U,                                         0U},                                        /*   AES_ACCEL_CLK clock          */
#endif
#if defined(CLOCK_IP_HAS_AES_APP0_CLK)
    {CLOCK_IP_PARTITION_1_INDEX,       CLOCK_IP_COLLECTION_3_INDEX,      MC_ME_PRTN1_COFB3_CLKEN_REQ116_SHIFT,        MC_ME_PRTN1_COFB3_CLKEN_REQ116_119_MASK},      /*   AES_APP0_CLK clock          */
#else
    {0U,                               0U,                               0U,                                         0U},                                        /*   AES_APP0_CLK clock          */
#endif
#if defined(CLOCK_IP_HAS_AES_APP1_CLK)
    {CLOCK_IP_PARTITION_1_INDEX,       CLOCK_IP_COLLECTION_3_INDEX,      MC_ME_PRTN1_COFB3_CLKEN_REQ120_SHIFT,        MC_ME_PRTN1_COFB3_CLKEN_REQ120_123_MASK},      /*   AES_APP1_CLK clock          */
#else
    {0U,                               0U,                               0U,                                         0U},                                        /*   AES_APP1_CLK clock          */
#endif
#if defined(CLOCK_IP_HAS_AES_APP2_CLK)
    {CLOCK_IP_PARTITION_1_INDEX,       CLOCK_IP_COLLECTION_3_INDEX,      MC_ME_PRTN1_COFB3_CLKEN_REQ124_SHIFT,        MC_ME_PRTN1_COFB3_CLKEN_REQ124_127_MASK},      /*   AES_APP2_CLK clock          */
#else
    {0U,                               0U,                               0U,                                         0U},                                        /*   AES_APP2_CLK clock          */
#endif
#if defined(CLOCK_IP_HAS_AES_APP3_CLK)
    {CLOCK_IP_PARTITION_2_INDEX,       CLOCK_IP_COLLECTION_2_INDEX,      MC_ME_PRTN2_COFB2_CLKEN_REQ72_SHIFT,        MC_ME_PRTN2_COFB2_CLKEN_REQ72_75_MASK},        /*   AES_APP3_CLK clock          */
#else
    {0U,                               0U,                               0U,                                         0U},                                        /*   AES_APP3_CLK clock          */
#endif
#if defined(CLOCK_IP_HAS_AES_APP4_CLK)
    {CLOCK_IP_PARTITION_2_INDEX,       CLOCK_IP_COLLECTION_2_INDEX,      MC_ME_PRTN2_COFB2_CLKEN_REQ76_SHIFT,        MC_ME_PRTN2_COFB2_CLKEN_REQ76_79_MASK},        /*   AES_APP4_CLK clock          */
#else
    {0U,                               0U,                               0U,                                         0U},                                        /*   AES_APP4_CLK clock          */
#endif
#if defined(CLOCK_IP_HAS_AES_APP5_CLK)
    {CLOCK_IP_PARTITION_2_INDEX,       CLOCK_IP_COLLECTION_2_INDEX,      MC_ME_PRTN2_COFB2_CLKEN_REQ80_SHIFT,        MC_ME_PRTN2_COFB2_CLKEN_REQ80_83_MASK},        /*   AES_APP5_CLK clock          */
#else
    {0U,                               0U,                               0U,                                         0U},                                        /*   AES_APP5_CLK clock          */
#endif
#if defined(CLOCK_IP_HAS_AES_APP6_CLK)
    {CLOCK_IP_PARTITION_2_INDEX,       CLOCK_IP_COLLECTION_2_INDEX,      MC_ME_PRTN2_COFB2_CLKEN_REQ84_SHIFT,        MC_ME_PRTN2_COFB2_CLKEN_REQ84_87_MASK},        /*   AES_APP6_CLK clock          */
#else
    {0U,                               0U,                               0U,                                         0U},                                        /*   AES_APP6_CLK clock          */
#endif
#if defined(CLOCK_IP_HAS_AES_APP7_CLK)
    {CLOCK_IP_PARTITION_2_INDEX,       CLOCK_IP_COLLECTION_2_INDEX,      MC_ME_PRTN2_COFB2_CLKEN_REQ88_SHIFT,        MC_ME_PRTN2_COFB2_CLKEN_REQ88_91_MASK},        /*   AES_APP7_CLK clock          */
#else
