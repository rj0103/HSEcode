...
#define CDD_PLATFORM_INTCTRL_IP_AR_RELEASE_MINOR_VERSION_C           9
#define CDD_PLATFORM_INTCTRL_IP_AR_RELEASE_REVISION_VERSION_C        0
#define CDD_PLATFORM_INTCTRL_IP_SW_MAJOR_VERSION_C                   7
#define CDD_PLATFORM_INTCTRL_IP_SW_MINOR_VERSION_C                   0
#define CDD_PLATFORM_INTCTRL_IP_SW_PATCH_VERSION_C                   1
/*==================================================================================================
                                      FILE VERSION CHECKS
==================================================================================================*/
                                         ...
                                         IntCtrl_Ip_IrqHandlerType* const pfOldHandler)
{
    ...
    DevAssert((sint32)INT_CTRL_IP_MIN_IRQ <= s32DevIrqNumber);
    DevAssert(s32DevIrqNumber <= (sint32)INT_CTRL_IP_MAX_IRQ);
    ...
    extern uint32 VTABLE[INT_CTRL_IP_MAX_IRQ + 1U];
...
void IntCtrl_Ip_EnableIrqPrivileged(IRQn_Type eIrqNumber)
{
    ...
    DevAssert((sint32)eIrqNumber <= (sint32)INT_CTRL_IP_MAX_IRQ);
#endif /*(INT_CTRL_IP_DEV_ERROR_DETECT == STD_ON) */
    /* Enable interrupt */
#if ((INT_CTRL_IP_CORTEXR == STD_ON) || (INT_CTRL_IP_CORTEXA == STD_ON))
...
void IntCtrl_Ip_SetPriorityPrivileged(IRQn_Type eIrqNumber, uint8 u8Priority)
{
    ...
    DevAssert((sint32)INT_CTRL_IP_MIN_IRQ <= (sint32)eIrqNumber);
    DevAssert((sint32)eIrqNumber <= (sint32)INT_CTRL_IP_MAX_IRQ);
...
uint8 IntCtrl_Ip_GetPriorityPrivileged(IRQn_Type eIrqNumber)
{
    ...
    uint8 shift = (uint8)(8U - INT_CTRL_IP_NVIC_PRIO_BITS);
        ...
        u8Priority = (uint8)(((uint32)S32_NVIC->IP[(uint32)(eIrqNumber)] >> shift) & 0xFFU);
    #else
        uint32 iprVectorId = (uint32)(eIrqNumber) >> 2U;
        uint8 priByteShift = (uint8)((((uint8)(eIrqNumber)) & 0x3U) << 3U);
