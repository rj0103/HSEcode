...
static uint64 Clock_Ip_Get_LPUART1_CLK_Frequency(void)
{
     ...
     defined(CLOCK_IP_DERIVATIVE_004) || defined(CLOCK_IP_DERIVATIVE_007) || defined(CLOCK_IP_DERIVATIVE_010) || defined(CLOCK_IP_DERIVATIVE_002) || \
...
static uint64 Clock_Ip_Get_AES_ACCEL_CLK_Frequency(void)
{
    ...
    Frequency &= Clock_Ip_u32EnableGate[(uint32)((IP_MC_ME->PRTN1_COFB3_STAT & MC_ME_PRTN1_COFB3_CLKEN_REQ112_115_MASK) == MC_ME_PRTN1_COFB3_CLKEN_REQ112_115_MASK)];
    return Frequency;
}
#endif
#if defined(CLOCK_IP_HAS_AES_APP0_CLK)
...
static uint64 Clock_Ip_Get_AES_APP0_CLK_Frequency(void)
{
    ...
    Frequency &= Clock_Ip_u32EnableGate[(uint32)((IP_MC_ME->PRTN1_COFB3_STAT & MC_ME_PRTN1_COFB3_CLKEN_REQ116_119_MASK) == MC_ME_PRTN1_COFB3_CLKEN_REQ116_119_MASK)];
    return Frequency;
}
#endif
#if defined(CLOCK_IP_HAS_AES_APP1_CLK)
...
static uint64 Clock_Ip_Get_AES_APP1_CLK_Frequency(void)
{
    ...
    Frequency &= Clock_Ip_u32EnableGate[(uint32)((IP_MC_ME->PRTN1_COFB3_STAT & MC_ME_PRTN1_COFB3_CLKEN_REQ120_123_MASK) == MC_ME_PRTN1_COFB3_CLKEN_REQ120_123_MASK)];
    return Frequency;
}
#endif
#if defined(CLOCK_IP_HAS_AES_APP2_CLK)
...
static uint64 Clock_Ip_Get_AES_APP2_CLK_Frequency(void)
{
    ...
    Frequency &= Clock_Ip_u32EnableGate[(uint32)((IP_MC_ME->PRTN1_COFB3_STAT & MC_ME_PRTN1_COFB3_CLKEN_REQ124_127_MASK) == MC_ME_PRTN1_COFB3_CLKEN_REQ124_127_MASK)];
    return Frequency;
}
#endif
#if defined(CLOCK_IP_HAS_AES_APP3_CLK)
...
static uint64 Clock_Ip_Get_AES_APP3_CLK_Frequency(void)
{
    ...
    Frequency &= Clock_Ip_u32EnableGate[(uint32)((IP_MC_ME->PRTN2_COFB2_STAT & MC_ME_PRTN2_COFB2_CLKEN_REQ72_75_MASK) == MC_ME_PRTN2_COFB2_CLKEN_REQ72_75_MASK)];
    return Frequency;
}
#endif
#if defined(CLOCK_IP_HAS_AES_APP4_CLK)
...
static uint64 Clock_Ip_Get_AES_APP4_CLK_Frequency(void)
{
    ...
    Frequency &= Clock_Ip_u32EnableGate[(uint32)((IP_MC_ME->PRTN2_COFB2_STAT & MC_ME_PRTN2_COFB2_CLKEN_REQ76_79_MASK) == MC_ME_PRTN2_COFB2_CLKEN_REQ76_79_MASK)];
    return Frequency;
}
#endif
#if defined(CLOCK_IP_HAS_AES_APP5_CLK)
...
static uint64 Clock_Ip_Get_AES_APP5_CLK_Frequency(void)
{
    ...
    Frequency &= Clock_Ip_u32EnableGate[(uint32)((IP_MC_ME->PRTN2_COFB2_STAT & MC_ME_PRTN2_COFB2_CLKEN_REQ80_83_MASK) == MC_ME_PRTN2_COFB2_CLKEN_REQ80_83_MASK)];
    return Frequency;
}
#endif
#if defined(CLOCK_IP_HAS_AES_APP6_CLK)
...
static uint64 Clock_Ip_Get_AES_APP6_CLK_Frequency(void)
{
    ...
    Frequency &= Clock_Ip_u32EnableGate[(uint32)((IP_MC_ME->PRTN2_COFB2_STAT & MC_ME_PRTN2_COFB2_CLKEN_REQ84_87_MASK) == MC_ME_PRTN2_COFB2_CLKEN_REQ84_87_MASK)];
    return Frequency;
}
#endif
#if defined(CLOCK_IP_HAS_AES_APP7_CLK)
...
static uint64 Clock_Ip_Get_AES_APP7_CLK_Frequency(void)
{
    ...
    Frequency &= Clock_Ip_u32EnableGate[(uint32)((IP_MC_ME->PRTN2_COFB2_STAT & MC_ME_PRTN2_COFB2_CLKEN_REQ88_91_MASK) == MC_ME_PRTN2_COFB2_CLKEN_REQ88_91_MASK)];
    return Frequency;
}
#endif
